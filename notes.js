$(document).ready(function(){ //wrap in jquery ready function
  ...
  var choice = 10; //...keep track of number limit choice
  ...
  var questionGenerator = function () {
    ...
    var num1 = randomNumberGenerator(choice); //size is 10 for now. change to variable that holds the user choice
  ...
  var updateNumberLimit = function (choice) { //create a function
    //console.log(choice);
    value = choice;
    //$('#value').val() // taking the slider's value
    //console.log('value is: ' + value); //and logging it to the console
    $('#value').text(choice);
  }
